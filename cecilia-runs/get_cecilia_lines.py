...
for file in dir:  # for every galaxy in this cecilia abundance directory
    #if (file == "cecilia_2593_13.abund.fits") | (file == "cecilia_2593_252.abund.fits"):
    while (file != "cecilia_2593_3.abund.fits") | (file != "cecilia_2593_35.abund.fits"):
        ...
        if i == 0:
            ...
            mos = hdu[7].data
            # BAH! have to update the data we're using every time
            lines235 = (hdu[1].data)
            lines395 = hdu[3].data 
        ...
        hb_ind = (line_list == 'O  2 3726.03A')
        print(id)
        print("o2 lum after mosfire", line_lum[hb_ind], "lum", line_lum_unc[hb_ind])
        ...
        flux_name_235 = lines235["WAVELENGTH"][to_use_235]
        ...
        for j, line in enumerate(lum_235):
            # print(j, line)
            #print(name_235[j], line, lum_235[j], flux_name_235[j], flux_235[j])
        ...
        print("hb flux after g235m", line_flux[hb_ind], "lum", line_lum[hb_ind], "\n")
        ...
        s3a = (dic['line_name'] == 'H  1 4861.32A')
        #print(id, "hbeta values")
        #print("line luminosity", dic["line_lum"][s3a], "line flux", dic["line_flux"][s3a], "line flux sn", dic["line_flux"][s3a]/dic["line_flux_unc"][s3a], "lum sn", dic["line_lum"][s3a]/dic["line_lum_unc"][s3a])
