...
galaxies = galaxy_names = ["BX523", "BX587", "BX628", "D40", "fBM40", "fBM47", "fC23"] #["BX216", "BX274", "BX336", "BX341", "BX348", "BX350", "BX390", "BX418", "BX429", "BX461", "BX474", 
                           #, "MD41"]

for galaxy in galaxies:
    print(galaxy)
    nolowion = False
    nolowion_noarsulf = False
    full_lines = True
    ...
    "so there's basically the lines that are observed and the lines that are upper limits. wav_ind contains both."
    ...
    def loglike_cue(model_params):
        ...
        #     print(obs['line_name'][wav_ind][i], "delta squared", delta[i]**2, "line var", line_var[wav_ind][i])
    ...
    with open("cue-results/correct-ionizing-spec-priors/"+galaxy+"_results_"+endtag+"_stellar.pkl", 'wb') as f:
    ...
    plt.savefig("/home/carolinevr/cue/cecilia-runs/figures/correct-ionizing-spec-priors-fluxSN/"+galaxy+"_cornerplot_"+endtag+"_stellar.png")
    ...
    with open("line-predictions/correct-ionizing-spec-priors/"+galaxy+" "+endtag+".pkl", 'wb') as f:
    ...
    plt.tight_layout()
    plt.savefig("/home/carolinevr/cue/cecilia-runs/figures/correct-ionizing-spec-priors-fluxSN/"+galaxy+"_lineprediction_"+endtag+"_stellar.png")